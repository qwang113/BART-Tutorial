...
```{r warning=FALSE}
sim_res <- train_bart(x = sim_x, y = sim_y, mcmc_par = list(iter = 1000, burn = 200, thin = 2),hyper = list(alpha = 0.95, beta = 1, c = 0.01, alpha_sig = 1, beta_sig = 1), control = list(node_min_size = 10))
...
res_rpart <- sim_dat[,1] - yhat_rpart
res_cart <- pred_y_mean_all - sim_dat[,1]
