...
```{r warning=FALSE}
sim_res <- train_bart(x = sim_x, y = sim_y, mcmc_par = list(iter = 1000, burn = 2000, thin = 2),hyper = list(alpha = 0.95, beta = 3, c = 0.001, alpha_sig = 10, beta_sig = 4), control = list(node_min_size = 100))
